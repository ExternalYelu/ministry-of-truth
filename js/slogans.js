...
(function(){
  ...
  const cObs=new IntersectionObserver((entries)=>{
    entries.forEach(e=>{
      ...
      const el=e.target;cObs.unobserve(el);
  ...
  document.querySelectorAll('.sl-stat-num[data-count]').forEach(el=>cObs.observe(el));
  ...
  document.querySelectorAll('.sl-section').forEach(el=>sObs.observe(el));
